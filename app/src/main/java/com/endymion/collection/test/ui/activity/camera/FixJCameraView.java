 ...
 */
public class FixJCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    public FixJCameraView(Context context) {
        this(context, null);
    }

    public FixJCameraView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixJCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        //get AttributeSet
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.cjt2325.cameralibrary.R.styleable.JCameraView, defStyleAttr, 0);
        iconSize = a.getDimensionPixelSize(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 35, getResources().getDisplayMetrics()));
        iconMargin = a.getDimensionPixelSize(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconMargin, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
        iconSrc = a.getResourceId(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconSrc, com.cjt2325.cameralibrary.R.drawable.ic_camera);
        iconLeft = a.getResourceId(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconLeft, 0);
        iconRight = a.getResourceId(com.cjt2325.cameralibrary.R.styleable.JCameraView_iconRight, 0);
        duration = a.getInteger(com.cjt2325.cameralibrary.R.styleable.JCameraView_duration_max, 10 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(com.cjt2325.cameralibrary.R.layout.camera_view, this);
        mVideoView = (VideoView) view.findViewById(com.cjt2325.cameralibrary.R.id.video_preview);
        mPhoto = (ImageView) view.findViewById(com.cjt2325.cameralibrary.R.id.image_photo);
        mSwitchCamera = (ImageView) view.findViewById(com.cjt2325.cameralibrary.R.id.image_switch);
        mSwitchCamera.setImageResource(iconSrc);
        mFlashLamp = (ImageView) view.findViewById(com.cjt2325.cameralibrary.R.id.image_flash);
        setFlashRes();
        ...
        mCaptureLayout = (CaptureLayout) view.findViewById(com.cjt2325.cameralibrary.R.id.capture_layout);
        mCaptureLayout.setDuration(duration);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mFoucsView = (FoucsView) view.findViewById(com.cjt2325.cameralibrary.R.id.fouce_view);
...
//        });
    ...
    public void cameraHasOpened() {
        FixCameraInterface.getInstance().doStartPreview(mVideoView.getHolder(), screenProp);
    }
    ...
    public void onResume() {
        ...
        FixCameraInterface.getInstance().registerSensorManager(mContext);
        FixCameraInterface.getInstance().setSwitchView(mSwitchCamera, mFlashLamp);
    ...
    public void onPause() {
        ...
        FixCameraInterface.getInstance().isPreview(false);
        FixCameraInterface.getInstance().unregisterSensorManager(mContext);
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                FixCameraInterface.getInstance().doOpenCamera(FixJCameraView.this);
            }
        }.start();
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        FixCameraInterface.getInstance().doDestroyCamera();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setSaveVideoPath(String path) {
        FixCameraInterface.getInstance().setSaveVideoPath(path);
    }
    ...
    public void setErrorLisenter(ErrorListener errorLisenter) {
        ...
        FixCameraInterface.getInstance().setErrorLinsenter(errorLisenter);
    }
    ...
    public void setMediaQuality(int quality) {
        FixCameraInterface.getInstance().setMediaQuality(quality);
    }
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        FixJCameraView.this.firstFrame = firstFrame;
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_AUTO:
                mFlashLamp.setImageResource(com.cjt2325.cameralibrary.R.drawable.ic_flash_auto);
                machine.flash(Camera.Parameters.FLASH_MODE_AUTO);
                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(com.cjt2325.cameralibrary.R.drawable.ic_flash_on);
                machine.flash(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(com.cjt2325.cameralibrary.R.drawable.ic_flash_off);
